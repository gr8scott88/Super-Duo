...
public class scoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        String gameDescription = cursor.getString(COL_HOME) + " versus " + cursor.getString(COL_AWAY);
        Log.v(TAG, "Setting content description of: " + gameDescription);
        view.setContentDescription(gameDescription);
